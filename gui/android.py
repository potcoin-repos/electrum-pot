...
from electrum_pot import SimpleConfig, Wallet, WalletStorage, format_satoshis, mnemonic_encode, mnemonic_decode
        ...
        if event["name"]=="click":
            ...
            if out == 'contacts':
                ...
                if receive_addr:
                    ...
                    if amount:
                        receive_addr = 'potcoin:%s?amount=%s'%(receive_addr, amount)
        ...
        if event["name"] == "click":
            ...
            if id=="buttonPay":
                ...
                if not is_valid(recipient):
                    modal_dialog('Error','Invalid Potcoin address')
                    continue
