...
from electrum_pot import mnemonic, pyqrnative, WalletStorage, Wallet

Gdk.threads_init()
APP_NAME = "Electrum-POT"
import platform
MONOSPACE_FONT = 'Lucida Console' if platform.system() == 'Windows' else 'monospace'

from electrum_pot.util import format_satoshis, parse_URI
from electrum_pot.network import DEFAULT_SERVERS
from electrum_pot.bitcoin import MIN_RELAY_TX_FEE
...
class ElectrumWindow:
    ...
    def do_send(self, w, data):
        ...
        if not is_valid(to_address):
            self.show_message( "invalid potcoin address:\n"+to_address)
            return
