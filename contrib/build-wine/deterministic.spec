...
a = Analysis(['electrum-pot', 'gui/qt/main_window.py', 'gui/qt/lite_window.py', 'gui/text.py',
...
exe = EXE(pyz,
          ...
          a.binaries,
          a.datas,
          name=os.path.join('build\\pyi.win32\\electrum-pot', 'electrum-pot.exe'),
          debug=False,
          strip=None,
          upx=False,
...
coll = COLLECT(exe,
               ...
               icon='icons/electrum.ico',
               console=False,
               name=os.path.join('dist', 'electrum-pot'))
